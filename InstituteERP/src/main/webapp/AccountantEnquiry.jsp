...
<h2><a href="AccountantReg.jsp">Reg</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="AccountantFees.jsp">Fees</a>&nbsp&nbsp&nbsp&nbsp&nbsp<a href="AccountantLogout.jsp">Logout</a></h2>

</header>
<section>
<center>
<h1><font color="white">This is Accountant page<% session.getAttribute("uid");%></font></h1>
<br><br>
